...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("BibleDB.sqlite")
        
        // Load the existing database
        if !FileManager.default.fileExists(atPath: url!.path) {
            let sourceSqliteURLs = [Bundle.main.url(forResource: "BibleDB", withExtension: "sqlite")!]
            let destSqliteURLs = [self.applicationDocumentsDirectory.appendingPathComponent("BibleDB.sqlite")]
